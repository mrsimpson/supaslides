...
<template>
  ...
  E-Mail-Adresse:
  <p><a href="mailto:slideshow@beimir.net">slideshow@beimir.net</a></p>
  Impressum:
  <p>
    <a href="https://slideshow.no-panic.org/imprint" target="_blank"
      >https://slideshow.no-panic.org/imprint</a
    >
  </p>
  ...
  <p>
    ...
    erforderlich ist, wird die IP-Adresse gekürzt (auch als "IP-Masking" bezeichnet). Hierbei werden
    die letzten beiden Ziffern, bzw. der letzte Teil der IP-Adresse nach einem Punkt entfernt, bzw.
    durch Platzhalter ersetzt. Mit der Kürzung der IP-Adresse soll die Identifizierung einer Person
  ...
  <p>
    ...
    im Rahmen einer Anmeldung zum Newsletter dessen Inhalte konkret umschrieben werden, sind sie für
  ...
  <p>
    ...
    E-Mail-Adresse angeben. Wir können Sie jedoch bitten, einen Namen, zwecks persönlicher Ansprache
    im Newsletter, oder weitere Angaben, sofern diese für die Zwecke des Newsletters erforderlich
    sind, zu tätigen.
  </p>
  <p>
    <strong>Double-Opt-In-Verfahren:</strong> Die Anmeldung zu unserem Newsletter erfolgt
    grundsätzlich in einem sogenannte Double-Opt-In-Verfahren. D.h., Sie erhalten nach der Anmeldung
  ...
  <p>
    ...
    einer Einwilligung bestätigt wird. Im Fall von Pflichten zur dauerhaften Beachtung von
  ...
  <p>
    ...
    zu Zwecken des Nachweises seines ordnungsgemäßen Ablaufs. Soweit wir einen Dienstleister mit dem
  ...
  <ul class="m-elements">
    ...
    <li>
      ...
      widersprechen. Einen Link zur Kündigung des Newsletters finden Sie entweder am Ende eines
  ...
  <ul class="m-elements">
    <li>
      ...
      sogenannte "web-beacon“, d.h., eine pixelgroße Datei, die beim Öffnen des Newsletters von
      ...
      Informationen zum Browser und Ihrem System, als auch Ihre IP-Adresse und der Zeitpunkt des
      Abrufs, erhoben. Diese Informationen werden zur technischen Verbesserung unseres Newsletters
      anhand der technischen Daten oder der Zielgruppen und ihres Leseverhaltens auf Basis ihrer
      Abruforte (die mit Hilfe der IP-Adresse bestimmbar sind) oder der Zugriffszeiten genutzt.
      Diese Analyse beinhaltet ebenfalls die Feststellung, ob die Newsletter geöffnet werden, wann
      sie geöffnet werden und <strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1
      lit. a) DSGVO).
    </li>
  </ul>
  ...
  <ul class="m-elements">
    <li>
      ...
      nicht mit Dritten geteilt; <br /><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen
      (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); <br /><strong>Website: &nbsp;</strong>
